...
def main(hparams):
    ...
    trainer = Trainer(
            ...
            callbacks=[checkpoint, TQDMProgressBar()],
...
def parse_args():
    ...
    parser.add_argument('--run_dir', type=str, default='_exp/segmentation', help='directory for saving run outputs (logs, ckpt, etc.)')
    ...
    parser.add_argument('--bin_cls', default=1.0, type=float, help='coefficient of binary classification loss')
    parser.add_argument('--phn_cls', default=1.0, type=float, help='coefficient of phoneme classification loss')
